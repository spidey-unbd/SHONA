...
BOT_TOKEN = getenv("BOT_TOKEN","8402108302:AAFp1mhiKmJ_3ZZRmyWvmz7HMtEb9bVeAzg")

OWNER_ID = int(getenv("OWNER_ID", 6092520782))
OWNER_USERNAME = getenv("OWNER_USERNAME", "unbd777")
BOT_USERNAME = getenv("BOT_USERNAME", "unbd_music_bot")
BOT_NAME = getenv("BOT_NAME", "『 𝐔ɴʙᴅ 』 ꭙꤪꤨꤪ 𝐌ᴜꜱɪᴄ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "『 𝐔ɴʙᴅ 』 ꭙꤪꤨꤪ 𝐌ᴜꜱɪᴄ - 𝐀ꜱꜱɪꜱ ♪")
...
# ── Git / updates ──────────────────────────────────────────────────────────────
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/hbbb02219-hue/SHONA")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN")  # needed if repo is private

# ── Support links ──────────────────────────────────────────────────────────────
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ganaasupport")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+BdXGr4nsBI80YjI1")
...
START_VIDS = [
    ...
    "https://files.catbox.moe/vykrv0.mp4",
...
PING_VID_URL = "https://files.catbox.moe/0a7opa.mp4"
PLAYLIST_IMG_URL = "https://files.catbox.moe/yhaja5.jpg"
STATS_VID_URL = "https://files.catbox.moe/4597ve.mp4"
